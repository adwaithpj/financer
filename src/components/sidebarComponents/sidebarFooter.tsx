...
import { Crown, User, Moon, Sun } from '@phosphor-icons/react';
...
export function SidebarFooter({ showExpanded }: SidebarFooterProps) {
  ...
  return (
    <div className="mt-auto flex flex-col border-t border-neutral-200 bg-white text-black transition-colors duration-300 dark:border-neutral-800 dark:bg-[#111111] dark:text-white">
      {expanded ? (
        <>
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-white py-5 text-lg font-black uppercase text-black transition-colors hover:bg-black hover:text-white dark:bg-[#111111] dark:text-white dark:hover:bg-white dark:hover:text-black"
          >
            {theme === 'light' ? (
        ...
        <>
          ...
          <button
            onClick={() => setTheme(theme === 'light' ? 'dark' : 'light')}
            className="flex items-center justify-center bg-white py-5 text-black transition-colors hover:bg-black hover:text-white dark:bg-[#111111] dark:text-white dark:hover:bg-white dark:hover:text-black"
            title="Toggle Theme"
          >
            {theme === 'light' ? (
